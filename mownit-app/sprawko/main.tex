...
apogeum dla $n=15$, gdzie błąd maksymalny wyniósł aż $E_{max} \approx 576,22$, po czym zaczęło stopniowo zanikać. 
...
W rysunkach \ref{fig:runge20} i \ref{fig:runge25} pokazano jak efekt Rungego zanika dla funkcji f dla wyższych stopni wielomianu $n>=15$. Jest to zachowanie
typowe dla funkcji których szereg Maclurina ma promień zbieżności $R=\infty$ (czyli \[\lim _{n \to \infty}\])
